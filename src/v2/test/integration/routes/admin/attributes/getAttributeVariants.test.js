 ...
 * Tests
 */
describe("GET /api/v2/admin/attributes/:attributeID/variants", () => {
    it("should get all variants of an attribute", async () => {
        const res = await request(app)
            .get("/api/v2/admin/attributes/3/variants")
        ...
        for (const variant of res.body.variants) {
            ...
            expect(variant.attributes.material).toBeDefined();
        }
    });
    ...
    it("should return 404 if attribute is not found", async () => {
        const res = await request(app)
            .get("/api/v2/admin/attributes/111/variants")
            .set("Authorization", `Bearer ${accessToken}`);
    ...
    it("should return 401 if token is not provided", async () => {
        const res = await request(app).get(
            "/api/v2/admin/attributes/1/variants"
        );
