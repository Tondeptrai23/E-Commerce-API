 ...
 *
 * @example
 * const attributeFilter = (await AttributeVariantFilterBuilder.create(query)).build();
 *
 * @note
 * An instance of this class should be created using the 'create' method
 * instead of the constructor
 */
export default class AttributeVariantFilterBuilder extends QueryToSequelizeConditionConverter {
    #allowFields = [];
    ...
    /**
     * Create a new instance of AttributeVariantFilterBuilder
     *
     * @param {Object} requestQuery the query object to convert
     * @returns {AttributeVariantFilterBuilder} the instance of AttributeVariantFilterBuilder
     */
    static create = async (requestQuery) => {
        const allowFields = await attributeService.getAttributeNames();

        return new AttributeVariantFilterBuilder(requestQuery, allowFields);
    };
